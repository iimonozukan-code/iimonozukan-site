export default {
  ...
  "catalog.aiTools": "AI Catalog",
  "catalog.productsHint": "Browse products",
  "catalog.aiToolsHint": "Browse AI",
  "catalog.productCount": "{{count}} products",
  "catalog.aiToolCount": "{{count}} AI tools",
  "catalog.new": "NEW",

  "aiTools.metaTitle": "AI Catalog | Iimono Zukan",
  "aiTools.metaDescription": "Discover AI for work and creative projects, with use cases and pricing notes.",
  "aiTools.filterByUse": "Filter by use case",
  "aiTools.listTitle": "Available AI",
  "aiTools.itemCount": "{{count}} registered AI entries",
  "aiTools.empty": "No AI matched your filters",
